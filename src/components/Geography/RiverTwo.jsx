...
export const RiverTwo = ({ room }) => {
  ...
  return (
    <>
      <p>
        <strong>River (44)</strong> A fast flowing river is running from the top
        right hand corner to the bottom left hand corner of this area and will
