...
export const RopeBridgeOne = ({ room }) => {
  ...
  useEffect(() => {
    ...
    bridge.src = "assets/rope-bridge-1.png";
  ...
  return (
    <>
      <p>
        <strong>Rope Bridge (18)</strong> A huge area of the dungeon floor has
        at one time collapsed, leaving behind a deep void running from the top
        right hand corner to the bottom left hand corner of this area. At some
